...
class ConnectionTabletLayout extends ConsumerWidget {
  const ConnectionTabletLayout({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                ...state.methods.map((m) => Padding(
                  ...
                  child: ConnectionMethodCard(method: m),
                )),
                const SizedBox(height: AppSpacing.lg),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: AppSpacing.lg),
                const SectionHeader(title: 'Connection History'),
                const SizedBox(height: AppSpacing.sm),
