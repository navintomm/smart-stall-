...
class ManualControlMobileLayout extends ConsumerStatefulWidget {
  const ManualControlMobileLayout({super.key});

  @override
  ConsumerState<ManualControlMobileLayout> createState() => _ManualControlMobileLayoutState();
}

class _ManualControlMobileLayoutState extends ConsumerState<ManualControlMobileLayout> {
    ...
    return SafeArea(
      child: Column(
        children: [
          ...
          // 3. Fixed E-Stop at Bottom
          const Padding(
            padding: EdgeInsets.all(AppSpacing.md),
            child: EmergencyStopPanel(),
          ),
        ],
      ),
    );
